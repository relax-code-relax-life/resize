...
var _resizeBlock = __webpack_require__(0);

var _resizeBlock2 = _interopRequireDefault(_resizeBlock);
...
var getUrl = function getUrl(img) {
...
var getCoverSize = function getCoverSize(imgSize, containerSize) {
...
var getNatureSize = function getNatureSize(url) {
    var img = new Image();
...
function resize(ele, img, container) {

    var $tar = (0, _wwlDom2.default)(ele);
    var url, scale; //  w/h
    ...
    getUrl(img).then(function (_url) {
        ...
        var converSize = getCoverSize({ width: width, height: height }, containerSize);
        ...
        (0, _resizeBlock2.default)($tar[0], { container: container, scale: scale });
    });
}
